<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="GridViewToWord.Default" EnableEventValidation="false" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Button ID="Button1" runat="server" Text="Export to Word Document" OnClick="Button1_Click" />
        </div>
    </form>
</body>
</html>
